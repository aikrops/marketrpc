...
def market_kline(
    ...
    :param exchange: 交易所名称(default:binance)
    ...
    elif kline_interval_second not in [1, 60, 300, 600, 900, 1800]:
        raise ValueError("Kline interval second must be 1, 60, 300, 600, 900, or 1800.")
